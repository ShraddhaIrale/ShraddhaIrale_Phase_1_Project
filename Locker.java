	...
	public static void main(String[] args) {
		...
		String f,d,m;
		 ...
		 System.out.println("** Locker Project **");
			...
			File file2 = new File("C:\\Locker_Pvt_Ltd\\");
		 ...
		 case 1 : 
            ...
            {	
				 System.out.println("File Name : ");
				  f = sc.next();
				  File file = new File("C:\\Locker_Pvt_Ltd\\"+f+".txt");
		 ...
		 case 2 : //delete the file
			 ...
			 System.out.println("which file do you want to Delete : ");
			  ...
			  File file = new File("C:\\Locker_Pvt_Ltd\\"+d+".txt");
		 ...
		 case 3 ://search the file
			 ...
			 System.out.println("which file do you want to Search : ");
			  ...
			  File file1 = new File("C:\\Locker_Pvt_Ltd\\"+m+".txt");
			 if(file1.exists())
			  {
